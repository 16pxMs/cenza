...
export default function TargetsPageView({ goals, currency, totalIncome, onDone, isDesktop, onBack, initialStep = 0, existingTargets = {} }: {
  goals: string[]
  currency: string
  totalIncome: number
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <h2 style={{ fontSize: isDesktop ? 30 : 26, color: T.text1, margin: '0 0 8px', transition: 'all 0.2s ease' }}>
            {goalId === 'travel'
