...
import { loadGoalContributions } from '@/lib/loaders/goal-contributions'
...
export default async function GoalContributionsPage({ params }: PageProps) {
  ...
  const contributions = await loadGoalContributions(user.id, goalId, goal.addedAt)
