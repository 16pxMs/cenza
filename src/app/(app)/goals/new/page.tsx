...
// Step 2: Name (only for 'other')
// Step 3: Set target + live analysis
//   - Timeline selector → required monthly save
//   - % of income signal  (green / amber / red)
...
// ─── Inner page (uses useSearchParams so needs Suspense wrapper) ──────────────
...
function NewGoalInner() {
  ...
  // ── Benchmark tip for specific goal types ─────────────────────
  const benchmarkTip = (() => {
        ...
        <div style={{ marginTop: 24 }}>
          ...
          {monthlyRequired > 0 && (
            <div style={{
              ...
              {/* Reality check for stretch goals */}
