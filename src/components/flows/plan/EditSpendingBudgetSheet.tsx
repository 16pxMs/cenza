        ...
        <div style={{ marginTop: 16 }}>
          {showCustom ? (
            <div style={{
              ...
              <p style={{ margin: '0 0 10px', fontSize: 12, fontWeight: 600, color: T.textMuted, textTransform: 'uppercase', letterSpacing: '0.6px' }}>
                Custom category
              </p>
              <div style={{ display: 'flex', gap: 8, marginBottom: 10 }}>
                ...
                <div style={{
                  ...
                  borderRadius: 10, padding: '0 10px', height: 42, width: 110,
                  boxSizing: 'border-box',
                }}>
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                <button
                  onClick={() => { setShowCustom(false); setAddLabel(''); setAddAmount('') }}
                  style={{
